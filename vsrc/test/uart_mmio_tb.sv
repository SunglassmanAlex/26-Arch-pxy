...
;
    ...
    initial begin
        ...
        expect8(UART_IIR_FCR, 8'hc1, "uart_iir_below_trigger4");
        expect_exint(1'b0, "plic_uart_below_trigger4");
        inject_rx(8'h53, "uart_rx_trigger4_inject_3");
        expect8(UART_IIR_FCR, 8'hc4, "uart_iir_reaches_trigger4");
        ...
        expect8(UART_IIR_FCR, 8'hc1, "uart_iir_after_fcr_clear");
        ...
        expect8(UART_IIR_FCR, 8'hc6, "uart_iir_overrun_priority");
        ...
        expect8(UART_IIR_FCR, 8'hc1, "uart_iir_overrun_fifo_cleared");
        ...
        expect8(UART_IIR_FCR, 8'hc6, "uart_iir_line_errors_priority");
        ...
        expect8(UART_IIR_FCR, 8'hc1, "uart_iir_line_errors_cleared");
        ...
        expect8(UART_IIR_FCR, 8'hc6, "uart_iir_break_only_priority");
        ...
        expect8(UART_IIR_FCR, 8'hc1, "uart_iir_break_only_cleared");
        ...
        expect8(UART_IIR_FCR, 8'hc0, "uart_iir_modem_status_pending");
        ...
        expect8(UART_IIR_FCR, 8'hc1, "uart_iir_modem_cleared");
        ...
        expect8(UART_IIR_FCR, 8'hc2, "uart_iir_thre_pending");
        expect8(UART_IIR_FCR, 8'hc1, "uart_iir_thre_read_clear");
        ...
        expect8(UART_IIR_FCR, 8'hc2, "uart_iir_thre_after_tx");
