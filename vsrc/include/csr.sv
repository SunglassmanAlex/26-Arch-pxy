...
package csr_pkg;
  ...
  parameter u12 CSR_MCONFIGPTR = 12'hf15;
  ...
  parameter u12 CSR_CYCLE = 12'hc00;
  parameter u12 CSR_TIME = 12'hc01;
  parameter u12 CSR_INSTRET = 12'hc02;
  parameter u12 CSR_MCYCLE = 12'hb00;
  parameter u12 CSR_MINSTRET = 12'hb02;
  parameter u12 CSR_MTVAL = 12'h343;
  parameter u12 CSR_PMPADDR0 = 12'h3b0;
  parameter u12 CSR_PMPADDR1 = 12'h3b1;
  parameter u12 CSR_PMPADDR2 = 12'h3b2;
  parameter u12 CSR_PMPADDR3 = 12'h3b3;
  parameter u12 CSR_PMPADDR4 = 12'h3b4;
  parameter u12 CSR_PMPADDR5 = 12'h3b5;
  parameter u12 CSR_PMPADDR6 = 12'h3b6;
  parameter u12 CSR_PMPADDR7 = 12'h3b7;
