...
该 queue 子集已经覆盖 feature negotiation、descriptor/avail/used ring 的基本读写路径、indirect descriptor 链、event idx 中断节流和基础设备 reset，但还没有实现多 queue、更完整的 block feature 组合和动态配置变更通知。
